...
public class ProRemove extends AppCompatActivity {
    ListView usersList;
    TextView noUsersText;
    ArrayList<String> al = new ArrayList<>();
    int totalUsers = 0;
    ProgressDialog pd;
    String url = "https://testpro-b5951.firebaseio.com/professionals.json";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_users);
        // Toast.makeText(proRemove.this, "Not Yet", Toast.LENGTH_LONG).show();
        refresh();
    ...
    public void refresh(){
        ...
        pd = new ProgressDialog(ProRemove.this);
        ...
        RequestQueue rQueue = Volley.newRequestQueue(ProRemove.this);
        rQueue.add(request);
    }
